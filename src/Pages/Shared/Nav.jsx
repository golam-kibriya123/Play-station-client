...
const Nav = () => {
    ...
    return (
        <div className="navbar flex justify-between ">
            ...
            <div className='text-[#209CEE] font-bold relative'>
                ...
                <ul className={` flex flex-row  items-start space-x-5 w-[430px]  lg:w-auto absolute lg:static ${countClick ? 'top-12 -left-48' : '-top-56'} `}>
                    <li>
